...
build, you will find those prominently in the matrix. For comparable products we
...
OpenID Connect is this if you want them to see a screen similar to the following
one:
