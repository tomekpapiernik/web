...
2. If you only need an identity platform without OAuth2 there are a few
   ...
   2. ~~[Supertokens](https://supertokens.io)~~ - we no long endorse them due to
...
In these cases you have to weight whether you want to use one authentication
...
OpenID Conenct is this if you want them to see a screen similar to the following
one:
