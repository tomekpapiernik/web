...
seo:
  description: >
    Run a free OAuth2 Server and OpenID Connect Provider (OIDC) using open
    source software in under 10 minutes.
  title: >
...
<p>
  <figure>
    <video autoplay muted loop playsInline>
      <source
        src="../../images/articles/oauth2/oauth2-flow.mp4"
        type="video/mp4"
      />
      <source
        src="../../images/articles/oauth2/oauth2-flow.webm"
        type="video/webm"
      />
    </video>
    <figcaption>
      A typical OAuth2 Flow with GitHub acting as the OAuth2 Server and OpenID
      Connect Provider, and CircleCI as the OAuth2 Client.
    </figcaption>
  </figure>
</p>
...
### Ory Hydra: A Headless OAuth2 and OpenID Connect Provider written in Golang
...
The easiest OAuth2 flow to try out is the _Client Credentials Flow_. To perform
the flow we
...
head over to the [developer guide](https://www.ory.sh/docs/guides/hydra/).
