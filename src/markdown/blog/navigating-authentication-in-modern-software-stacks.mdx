...
support the underlying requirements for the feature to work. This can even be
the case when dealing with AuthN, some technologies make it difficult to
understand how AuthN fits in without breaking the User Experience (UX).
...
Javascript assets before the first content is displayed. Some examples of frameworks that allow for SSR are
[NextJs](https://nextjs.org/), [NuxtJs](https://v3.nuxtjs.org/)
